...
<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask id="mask3" mask-type="alpha" maskUnits="userSpaceOnUse" x="4" y="8" width="16" height="9">
      <path
    ...
    <g mask="url(#mask3)">
      <rect x="22" y="2" width="20" height="20" transform="rotate(90 22 2)" fill="currentColor" />
    </g>
  </svg>
</template>
